...
{
    public class Caudalie_Vinohydra_Sorbet_CreamModel : AuthPageModel
    {
        public bool IsAuthenticated { get; set; }
        public string UserName { get; set; }

        public Caudalie_Vinohydra_Sorbet_CreamModel(SessionService sessionService, ClientService authService, ProductService productService, CartService cartService) : base(sessionService)
        {
        ...
        public async Task<IActionResult> OnPostAddToCartAsync(int productId, int quantity)
        {
            ...
            try
            {
                var product = await _productService.SearcOneByNameAsync("Caudalie Vinohydra Sorbet Cream Set Xmas");
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            product = await _productService.SearcOneByNameAsync("Caudalie Vinohydra Sorbet Cream Set Xmas");
