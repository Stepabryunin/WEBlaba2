...
{
    public class Banderas_The_Icon_WomanModel : AuthPageModel
    {
        public bool IsAuthenticated { get; set; }
        public string UserName { get; set; }

        public Banderas_The_Icon_WomanModel(SessionService sessionService, ClientService authService, ProductService productService, CartService cartService) : base(sessionService)
        {
        ...
        public async Task<IActionResult> OnPostAddToCartAsync(int productId, int quantity)
        {
            ...
            try
            {
                var product = await _productService.SearcOneByNameAsync("Banderas The Icon Woman Eau de Parfum");
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            product = await _productService.SearcOneByNameAsync("Banderas The Icon Woman Eau de Parfum");
