...
{
    public class Emi_Ultra_Strong_NailModel : AuthPageModel
    {
        public bool IsAuthenticated { get; set; }
        public string UserName { get; set; }

        public Emi_Ultra_Strong_NailModel(SessionService sessionService, ClientService authService, ProductService productService, CartService cartService) : base(sessionService)
        {
        ...
        public async Task<IActionResult> OnPostAddToCartAsync(int productId, int quantity)
        {
            ...
            try
            {
                var product = await _productService.SearcOneByNameAsync("Emi Ultra Strong Nail Polish Gel Effect");
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            product = await _productService.SearcOneByNameAsync("Emi Ultra Strong Nail Polish Gel Effect");
