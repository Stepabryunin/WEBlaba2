...
{
    public class Issey_Miyake_Le_SelModel : AuthPageModel
    {
        public bool IsAuthenticated { get; set; }
        public string UserName { get; set; }

        public Issey_Miyake_Le_SelModel(SessionService sessionService, ClientService authService, ProductService productService, CartService cartService) : base(sessionService)
        {
        ...
        [BindProperty]
        public int Quantity { get; set; } = 1; // Добавьте это свойство
        ...
        // Добавьте этот метод для обработки добавления в корзину
        public async Task<IActionResult> OnPostAddToCartAsync(int productId, int quantity)
        {
            ...
            try
            {
                var product = await _productService.SearcOneByNameAsync("Issey Miyake Le Sel D'issey Eau de Toilette");
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            product = await _productService.SearcOneByNameAsync("Issey Miyake Le Sel D'issey Eau de Toilette");
