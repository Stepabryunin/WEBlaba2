...
{
    public class Caudalie_Vinopure_Salicylic_Spot_SolutionModel : AuthPageModel
    {
        public bool IsAuthenticated { get; set; }
        public string UserName { get; set; }

        public Caudalie_Vinopure_Salicylic_Spot_SolutionModel(SessionService sessionService, ClientService authService, ProductService productService, CartService cartService) : base(sessionService)
        {
        ...
        public async Task<IActionResult> OnPostAddToCartAsync(int productId, int quantity)
        {
            ...
            try
            {
                ...
                var product = await _productService.GetProductByIdAsync(7); // ID из логов
